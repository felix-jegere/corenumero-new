...
Output Structure (Mandatory JSON or Structured Markdown):
...
- The Gemini Synthesis: This is the "AI Edge." Identify contradictions in their numbers (e.g., a Life Path 1 but a Soul Urge 2) and explain how to balance these opposing energies.
- Future Trajectory: Based on the current year, provide a "Personal Year" forecast.
